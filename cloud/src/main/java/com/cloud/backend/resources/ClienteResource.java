...
import com.cloud.backend.dto.ClienteDTO;
import com.cloud.backend.dto.ClienteNewDTO;
import com.cloud.backend.service.ClienteService;
...
public class ClienteResource {
	...
	public ResponseEntity<Page<ClienteDTO>> findPage(
		...
		Page<Cliente> list = service.findPage(page, linePerPage, orgerBy, direction);
