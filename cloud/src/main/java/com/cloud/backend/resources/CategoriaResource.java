...
import com.cloud.backend.dto.CategoriaDTO;
import com.cloud.backend.service.CategoriaService;
...
public class CategoriaResource {
	...
	@ApiResponses(value = {
			@ApiResponse(code = 400, message = "Não é possível excluir uma categoria que possui iacs"), 
